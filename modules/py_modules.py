...
class IllegalMedia:
    ...
    def run(self):
        ...
        self.removeFileType("png") 
        self.removeFileType("gif") 
        self.removeFileType("tif") 
        self.removeFileType("bmp") 
        self.removeFileType("cvs") 
        self.removeFileType("snd") 
        self.removeFileType("wav") 
        self.removeFileType("ogg") 
        self.removeFileType("au") 
        self.removeFileType("mid")
        self.removeFileType("midi") 
        self.removeFileType("mov") 
        self.removeFileType("quicktime")
        self.removeFileType("avi") 
        self.removeFileType("mpg")
        self.removeFileType("flv")
